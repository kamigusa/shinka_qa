...
| **[Part 11](part11_hands_on_calculator/)** | 実践ハンズオン - 電卓 | 45分 | simple_calculatorを使った完全実践 | Part 3 |
| **[Part 12](part12_hands_on_banking/)** | 実践ハンズオン - 銀行システム | 60分 | banking_systemを使ったエンタープライズ実践 | Part 11 |

**Phase 2完了後の状態**:
- 変異戦略を戦略的に選択できる
- 実プロジェクトで成果を出せる
- エンタープライズレベルのシステムに適用できる
- チームに展開できる
